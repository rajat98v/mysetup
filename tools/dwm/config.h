...
static Key keys[] = {
	...
	{ MODKEY,			XK_p,			spawn,		SHCMD("maim ~/Pictures/Screenshots/$(date +%s).png && notify-send \"Screenshot Taken\" \"Saved to ~/Pictures/Screenshots\" ") },
	{ MODKEY|ShiftMask,		XK_p,			spawn,		SHCMD("	maim -i $(xdotool getactivewindow) ~/Pictures/Screenshots/$(date +%s).jpg && notify-send \"Screenshot Taken\" \"Active Window Screenshot \nSaved to ~/Pictures/Screenshots\" ") },
	{ MODKEY,			XK_bracketleft,		spawn,		SHCMD("xmodmap ~/.Xmodmap") },
	...
	{ MODKEY|ShiftMask,		XK_d,		spawn,		SHCMD("~/mysetup/scripts/main/rofiselect.sh") },
	/* { MODKEY,			XK_d,		spawn,          {.v = dmenucmd } }, */
	{ MODKEY,			XK_d,		spawn,		SHCMD("albert toggle") },
	{ MODKEY|ShiftMask,		XK_f,		spawn,		SHCMD("albert toggle") },
	...
	{ MODKEY|ShiftMask,		XK_Up,	spawn,	    SHCMD("amixer sset Master 5%+") },
	{ MODKEY|ShiftMask,		XK_Down,	spawn,	SHCMD("amixer sset Master 5%-") },
	{ MODKEY|ShiftMask,		XK_Left,	spawn,	SHCMD("light -U 5") },
	{ MODKEY|ShiftMask,		XK_Right,	spawn,	SHCMD("light -A 5") },
